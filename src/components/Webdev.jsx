    ...
    return (
        <div className="my-5">
            <div className="flex flex-col md:flex-row gap-10 uppercase ">
                ...
                <div className="w-full md:w-1/2 mx-auto h-5 my-10 animate__animated animate__fadeInRight">
                    ...
                    <div className="grid grid-cols-2 text-2xl justify-center items-center w-full border-r">
                        ...
                        <div className="py-5 px-10 mx-auto flex flex-col items-center gap-2 w-full border-l border-b hover:bg-gray-200 hover:scale-110 transition">
                            <DiMongodb></DiMongodb>
