...
const Card = () => {
    ...
    return (
        ...
        <div className="dark:text-white border-2 p-3 m-2 relative">
            ...
            <div className="my-2 p-3">
                <div className="w-fit bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 my-2 rounded dark:bg-blue-900 dark:text-blue-300 ">Default</div>
