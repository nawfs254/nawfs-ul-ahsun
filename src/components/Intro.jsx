...
const Intro = () => {
    return (
        <div className="w-full md:w-4/5 mx-auto my-16 flex flex-col-reverse lg:flex-row items-center gap-3 dark:text-white">
            <div className="w-full lg:w-1/2 items-center gap-3 justify-between space-y-5 mx-2">
                ...
                <div className="flex gap-4 justify-center lg:justify-start">
                    <Link to="https://github.com/nawfs254" target="_blank">
                        <FaGithub size={40}></FaGithub>
                    </Link>
                    <Link to="https://www.linkedin.com/in/nawfs-ul-ahsun" target="_blank">
                        <FaLinkedin size={40}></FaLinkedin>
                    </Link>
                    <Link to="https://www.facebook.com/nawfs-arnob" target="_blank">
